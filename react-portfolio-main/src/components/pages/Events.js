      ...
      <div className="service-container">
               ...
               <div className="service-info-content-container">
                  <div className="service-info-content">
                     ...
                     <p>
                        ...
                        para adaptarse a diferentes necesidades los convierte en
                        una herramienta imprescindible en el sector audiovisual.
                     </p>
                     <p>
                  ...
                  <div className="service-info-image">
                     <img src={eventImg} alt={t("aerial_photography")} />
                  </div>
               </div>
            </Card.Body>
         </Card>
         ...
         >
            <div className="service-questions-container">
               ...
               <p>
                  La fotografía con dron permite capturar imágenes desde ángulos
                  únicos y de grandes superficies, algo que antes solo era
                  posible con aviones o helicópteros. Gracias a los drones, los
                  costes se han reducido considerablemente al prescindir de
                  pilotos especializados y el alto consumo de combustible.
               </p>
               <p>
                  El precio del servicio varía en función de las necesidades del
                  proyecto, teniendo en cuenta factores como el tipo de equipo
                  utilizado, el número de vuelos, la localización y el trabajo
                  de producción y postproducción. Generalmente, el coste mínimo
                  de una sesión fotográfica con dron parte de unos 150€. Para
                  obtener un presupuesto personalizado, no dudes en contactarme.
               </p>
            </div>
         </div>
         <Contact />
